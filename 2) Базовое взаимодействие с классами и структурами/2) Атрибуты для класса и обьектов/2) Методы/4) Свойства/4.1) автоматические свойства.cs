...
class My_class{
/* Данное свойство создает поле number с следующими характеристиками:
    тип данных: int  
    модификатор доступа:  public 
    значением по умолчанию: 0
Данное свойство работает как сеттер и геттер 
*/
    public int number{get; set;} = 0; 
/* 
Так же в свойствах создающие поля можно использовать инициализатор
...
class Program{
    public static void Main(){ 
        ...
        // Взаимодействуем с полем обьекта через свойство 
        temp.number = 9; // сетер
